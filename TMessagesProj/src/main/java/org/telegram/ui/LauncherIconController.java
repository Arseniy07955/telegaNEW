...
public class LauncherIconController {
    ...
    public enum LauncherIcon {
        ...
        AQUA("AquaIcon", R.drawable.icon_4_background_sa, R.mipmap.icon_4_launcher_sa_foreground, R.string.AppIconAqua),
        PREMIUM("PremiumIcon", R.drawable.icon_3_background_sa, R.mipmap.icon_3_launcher_sa_foreground, R.string.AppIconPremium),
