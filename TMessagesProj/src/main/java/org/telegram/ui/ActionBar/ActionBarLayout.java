...
//        }
    ...
    public boolean presentFragment(NavigationParams params) {
        ...
        boolean needAnimation = preview || !forceWithoutAnimation && MessagesController.getGlobalMainSettings().getBoolean("view_animations", false);
...
//                layoutParams.topMargin += AndroidUtilities.dp(32);
    ...
    public void closeLastFragment(boolean animated, boolean forceNoAnimation) {
        ...
        setInnerTranslationX(0);
        boolean needAnimation = !forceNoAnimation && (inPreviewMode || transitionAnimationPreviewMode || animated && MessagesController.getGlobalMainSettings().getBoolean("view_animations", false));
        final BaseFragment currentFragment = fragmentsStack.get(fragmentsStack.size() - 1);
