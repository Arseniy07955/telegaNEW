...
рукопожатия, а не доказательством рабочего трафика. Явный новый старт подключения из GUI или rotation
сначала публикует `connect_start`, чтобы пользователь видел новую попытку, а не
старую terminal-ошибку выбранной строки.
